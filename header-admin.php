    ...
    <div class="flex items-stretch">
      <div class="dropdown dropdown-end">
        <div tabindex="0" role="button" class="btn btn-ghost rounded-btn text-white">
          <img class="w-10 h-10 rounded-full" src="upload-restaurant-logo/<?php echo $restaurant_logo ?>" alt="Restaurant Logo" />
          <?php echo $restaurant_name ?>
        </div>
        <ul tabindex="0" class="menu dropdown-content z-[1] p-2 shadow bg-base-100 rounded-box w-52 mt-4">
          <li><a href="restaurant-details.php">Change Details</a></li>
