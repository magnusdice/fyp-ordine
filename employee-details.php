      ...
      <div class="flex items-stretch">
        <div class="flex-none hidden lg:block">
          <ul class="menu menu-horizontal">
            ...
            <li>
              <a href="home-staff-page.php"><svg class="fill-current h-5 w-5 text-white" xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24">
                  <path d="M15.41,16.58L10.83,12L15.41,7.41L14,6L8,12L14,18L15.41,16.58Z"></path>
                </svg></a>
            </li>
            <li>
              <a href="home-staff-page.php"><svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div class="flex flex-row h-screen">
          ...
          <div class="flex flex-col bg-white justify-between items-center w-1/2 py-4 px-2 border-r-2 flex-none">
            <div class="flex flex-col flex-auto">
              <div class="avatar">
                <div class="w-80 shadow-md rounded">
          ...
          <main class="flex flex-col bg-white justify-between items-center w-1/2 py-4 px-2 border-r-2 flex-none">
            <div class="overflow-x-auto">
              ...
              <div class="mx-1 my-5 text-left">
                <input type="submit" class="btn btn-success" value="Edit" name="update-emp-staff-button">
    ...
    <div class="modal-box">
      <form action="CRUD-employee-functions.php" method="POST" class="card-body">
        ...
        <div class="form-control">
          ...
          <input type="password" name="new_password" required placeholder="New Password" class="input input-bordered" />
        </div>
        <div class="form-control">
          <label class="label">
            <span class="label-text">Confirm New Password</span>
          </label>
          <input type="password" name="confirm_password" required placeholder="Confirm New Password" class="input input-bordered" />
        </div>
        <div class="form-control mt-6">
          <input type="submit" value="Change" class="btn btn-primary" name="password-change-staff">
        </div>
      </form>
